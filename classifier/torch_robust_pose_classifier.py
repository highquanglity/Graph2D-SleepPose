...
# sample command : 
# python3 torch_heavy_robust_classifier.py --run mixedfullswap --n_epochs 100  --train /ske/data/kp_16_cover_modes/mixed/fullswaptrainmixed.csv --test /ske/data/kp_16_cover_modes/mixed/testmixed.csv --val /ske/data/kp_16_cover_modes/mixed/testmixed.csv
...
parser.add_argument("--latent",type=int,default=512,help="how large is the hidden layers of the model")
...
output_dir="output/robust_pose_classifier"
...
valset=Robust_Dataset_ske(opt.val)
...
net = RobustPoseClassifier(in_channels=2, n_classes=9, t_size=1, latent=opt.latent)
